...
{id:'aipe2',title:'6. AIPE — categoria e nível',fields:[q('aipeCategoryChoice','Categoria selecionada',['Não valorável','Ligeiro','Moderado','Importante','Muito importante','Importantíssimo']),q('aipeLevel','Nível dentro da categoria',['Baixo','Médio','Alto','Não definido']),n('aipeScore','Pontuação registrada','Registre a pontuação sem automatismo decisório.')]},
