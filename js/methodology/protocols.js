...
{id:'aipe1',title:'5. AIPE — impressão do impacto',fields:AIPE_CRITERIA.map(criterion=>q(criterion.field,criterion.question,criterion.options))},
...
{id:'aipe4',title:'7. AIPE — critérios complementares',fields:[...AIPE_CONTEXTS.map(context=>q(context.field,context.label,AIPE_CONTEXT_OPTIONS)),q(AIPE_PRIOR_EFFECT.field,AIPE_PRIOR_EFFECT.label,AIPE_PRIOR_EFFECT.options)]},
