...
export const KNOWLEDGE_SOURCES = freeze([
  ...
  freeze({
    ...
    note: 'A regra geral de cumulação da própria ABMLPM distingue sequelas sinérgicas (mesma função — somam-se diretamente, limitadas ao valor da perda total daquela função) de sequelas não sinérgicas (funções distintas — usa-se capacidade restante / Balthazard). A regra padrão — capacidade restante como base, e não soma direta — está confirmada em norma jurídica (Decreto-Lei nº 352/2007, Portugal, arts. da Tabela Nacional de Incapacidades, que abrange também a tabela de direito civil); a exceção sinérgica aparece descrita como princípio próprio da ABMLPM. Qual das duas rege especificamente os arts. 69º/70º/73º (Capítulo 10) não foi confirmado por leitura direta do documento — a soma direta do Capítulo 10 não deve ser presumida correta apenas por semelhança com a exceção sinérgica; a regra padrão do instituto é a capacidade restante.'
  }),
  freeze({
    id: 'aipe-brasil-2016',
